...
export const STATUS_CHIPS: StatusChipType[] = [
  ...
  { color: '#3A3226', label: 'Rejected', theme: ApplicationStatus.REJECTED },
  { color: '#3A3226', label: 'Rejected', theme: ReviewDecision.REJECT },
  ...
  { color: '#962123', label: 'Conflict', theme: ApplicationStatus.CONFLICT },
];
