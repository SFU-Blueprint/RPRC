      ...
      >
        <div className={inter.className}>
          <div className="mt-10 px-8">
            <h2
              className={`text-[28px] font-bold ${robotoCondensed.className}`}
            >
            ...
            >
              Please confirm you want to submit this review as approved? This
              will be logged to the review history.
            </p>
          </div>
